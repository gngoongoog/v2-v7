              ...
              <Card key={item.id} className="overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 sm:space-x-reverse">
                    ...
                    <div className="flex-shrink-0 w-full sm:w-auto">
                      <Link to={`/product/${item.id}`}>
                        <img
                          src={item.image_url}
                          alt={item.name}
                          className="w-full sm:w-20 h-48 sm:h-20 object-cover rounded-lg hover:opacity-80 transition-opacity"
                          onError={(e) => {
                    ...
                    {/* التحكم في الكمية */}
                    <div className="flex flex-row sm:flex-col items-center justify-between sm:justify-center w-full sm:w-auto space-x-4 sm:space-x-0 sm:space-y-2">
